...
static gboolean
try_to_connect(AthenaDropboxHookserv *hookserv);

static gboolean
handle_hook_server_input(GIOChannel *chan,
			 GIOCondition cond,
			 AthenaDropboxHookserv *hookserv) {
  /*debug_enter(); */
...
static void
watch_killer(AthenaDropboxHookserv *hookserv) {
...
gboolean athena_dropbox_hooks_force_reconnect(AthenaDropboxHookserv *hookserv) {
  debug_enter();
...
gboolean
athena_dropbox_hooks_is_connected(AthenaDropboxHookserv *hookserv) {
  return hookserv->connected;
}

void
athena_dropbox_hooks_setup(AthenaDropboxHookserv *hookserv) {
...
void athena_dropbox_hooks_add(AthenaDropboxHookserv *ndhs,
...
void
athena_dropbox_hooks_start(AthenaDropboxHookserv *hookserv) {
  try_to_connect(hookserv);
}
